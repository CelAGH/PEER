...
// Insert the post into the database
    ...
    function confirmation() {
        ...
        if (isset($_REQUEST['action_name'])) {
			...
			$poll_date1 = $_REQUEST['pd_d1'];
			$poll_date2 = $_REQUEST['pd_d2'];
			$poll_date3 = $_REQUEST['pd_d3'];
			$poll_date4 = $_REQUEST['pd_d4'];
			$poll_date5 = $_REQUEST['pd_d5'];
			$poll_date6 = $_REQUEST['pd_d6'];
			$poll_date7 = $_REQUEST['pd_d7'];
			$poll_date8 = $_REQUEST['pd_d8'];

			$poll_date11 = $_REQUEST['pd_d11'];
			$poll_date22 = $_REQUEST['pd_d22'];
			$poll_date33 = $_REQUEST['pd_d33'];
			$poll_date44 = $_REQUEST['pd_d44'];
			$poll_date55 = $_REQUEST['pd_d55'];
			$poll_date66 = $_REQUEST['pd_d66'];
			$poll_date77 = $_REQUEST['pd_d77'];
			$poll_date88 = $_REQUEST['pd_d88'];
			   ...
			   'poll_date1' => $poll_date1,
			   'poll_date2' => $poll_date2,
			   'poll_date3' => $poll_date3,
			   'poll_date4' => $poll_date4,
			   'poll_date5' => $poll_date5,
			   'poll_date6' => $poll_date6,
			   'poll_date7' => $poll_date7,
			   'poll_date8' => $poll_date8,
    		          'poll_date11' => $poll_date11,
			   'poll_date22' => $poll_date22,
			   'poll_date33' => $poll_date33,
			   'poll_date44' => $poll_date44,
			   'poll_date55' => $poll_date55,
			   'poll_date66' => $poll_date66,
			   'poll_date77' => $poll_date77,
			   'poll_date88' => $poll_date88
		      );
			   ...
			   $cos = $page->post_content;
				...
				//echo $poczatek.$onlyhint.$ahint;
                        ...
                        $cont = $onlyhint . $content . "<p></p>" . $poczatek . $ahint;
