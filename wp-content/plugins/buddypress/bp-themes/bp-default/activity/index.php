		...
		<div class="padder">
			...
			<div class="item-list-tabs activity-type-tabs" role="navigation">
				<ul>
					...
					<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>" title="<?php _e( 'The public activity for everyone on this site.', 'buddypress' ); ?>"><?php printf( __( 'Chat <span>%s</span>', 'buddypress' ), bp_get_total_member_count() ); ?></a></li>
