...
function bp_activity_delete_link() {
	...
	function bp_get_activity_delete_link() {
		...
		$link = '<a href="' . wp_nonce_url( $url, 'bp_activity_delete_link' ) . '" class="button item-button bp-secondary-action ' . $class . ' confirm" rel="nofollow">' . __( CHDELETE , 'buddypress' ) . '</a>';
...
function bp_send_public_message_button( $args = '' ) {
	...
	function bp_get_send_public_message_button( $args = '' ) {
		$defaults = array(
			...
			'link_text'         => __( 'Public Chat', 'buddypress' ),
