			...
			<ul id="members-list" class="item-list">
				<?php while ( bp_members() ) : bp_the_member(); ?>
					<li class="vcard">
						...
						<div class="item">
							<div class="item-title fn"><a href="<?php bp_member_permalink() ?>" title="<?php bp_member_name() ?>"><?php bp_member_name();
								echo " (@"; bp_member_user_nicename(); echo ")";
							 ?></a></div>
							<div class="item-meta">
								<span class="activity">
								<?php
	...
	function widget($args, $instance) {
		...
		<?php if ( bp_has_members( 'user_id=0&type=online&per_page=' . $instance['max_members'] . '&max=' . $instance['max_members'] . '&populate_extras=1' ) ) : ?>
			<div class="avatar-block">
				<?php while ( bp_members() ) : bp_the_member(); ?>
					<div class="item-avatar">
						<a href="<?php bp_member_permalink() ?>" title="<?php bp_member_name() ?>"><?php bp_member_avatar(); echo "&nbsp&nbsp&nbsp"; bp_member_name(); ?></a>
					</div>
				<?php endwhile; ?>
			</div>
		<?php else: ?>
