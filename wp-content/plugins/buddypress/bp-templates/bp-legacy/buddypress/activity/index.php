...
<div id="buddypress">
	<div id="buddypress-hint"><p><?php echo CHDESC;?> </p><div id="normalhint">
<p><?php echo CHDESC1;?> </p>	</div>
	</div>
	...
	<div class="item-list-tabs activity-type-tabs" role="navigation">
		<ul>
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>" title="<?php _e( 'The public activity for everyone on this site.', 'buddypress' ); ?>"><?php echo CHALLCHATS; printf( __( '<span>%s</span>', 'buddypress' ), bp_get_total_member_count() ); ?></a></li>
