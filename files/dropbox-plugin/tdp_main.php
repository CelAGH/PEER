...
if($allowupload=="true")
{$output.=' <h4>Upload new file</h4><table height="10"><tr><td>Here you can upload new file:</td><td align="center"><form method="post" action="" enctype="multipart/form-data">
        					
            <input type="file" name="file" /></td><td align="center"><input type="submit" value="Upload" />
       </form></td></tr></table><br />';
...
if($allowupload=="true")
{$output.=' <br /><h4>Upload new file</h4><table height="10"><tr><td>Here you can upload new file:</td><td align="center"><form method="post" action="" enctype="multipart/form-data">
